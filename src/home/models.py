...
class AnonymousTip(models.Model):
    ...
    userid = models.ForeignKey(AnonymousUser, models.SET_NULL, null=True,blank=True)
...
class Evidence(models.Model):
        ...
        anonymous_tip = models.ForeignKey(AnonymousTip, models.SET_NULL, blank=True, null=True )
